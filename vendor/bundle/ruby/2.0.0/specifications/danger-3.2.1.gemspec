...
Gem::Specification.new do |s|
  ...
  s.email = ["orta.therox@gmail.com".freeze, "danger@krausefx.com".freeze]
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<claide-plugins>.freeze, ["> 0.9.0"])
      ...
      s.add_runtime_dependency(%q<gitlab>.freeze, ["~> 3.7.0"])
      ...
      s.add_dependency(%q<claide-plugins>.freeze, ["> 0.9.0"])
      ...
      s.add_dependency(%q<gitlab>.freeze, ["~> 3.7.0"])
